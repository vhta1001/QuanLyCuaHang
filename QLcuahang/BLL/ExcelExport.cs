...
namespace BLL
{
    public class ExcelExport
    {
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer,string count,string tongtien ,string ngaylap,string idhd,string tennv,string tenncc)
        {
            if (pReplacer != null)
            {
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_BieuMau:
                    ...
                    arrByte = File.ReadAllBytes("HoaDonNhap.xls").ToArray();
                    break;
        ...
        public bool ExportKhoa(List<Class1> dataSource, ref string fileName, bool isPrintPreview, string count, string tongtien, string ngaylap, string idhd, string tennv, string tenncc)
        {
            // Check if data is null
        ...
        //    replacer.Add(V_TONGSO, "100");
            ...
            BuildReplacerCurrentDate(ref replacer,count,tongtien,ngaylap,idhd,tennv,tenncc);
