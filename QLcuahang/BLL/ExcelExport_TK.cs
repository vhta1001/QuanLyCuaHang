...
namespace BLL
{
    public class ExcelExport_TK
    {
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer,string count,string tong,string tennv)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%TenNV1", tennv);
               
                pReplacer.Add("%Tong", tong);
            }
        }
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_BieuMau:
                    ...
                    arrByte = File.ReadAllBytes("ThongKE.xls").ToArray();
                    break;
        ...
        public bool ExportKhoa(List<TK> dataSource, ref string fileName, bool isPrintPreview, string count, string tong, string tennv)
        {
            // Check if data is null
        ...
        //    replacer.Add(V_TONGSO, "100");
            ...
            BuildReplacerCurrentDate(ref replacer,  count,  tong,  tennv);
